        ...
        {tokenValido &&
          (<>
            <form onSubmit={handleSubmit}>
              ...
              <input type="submit" value="Guardad Nuevo Password" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" />
            </form>
            </>
          )}
